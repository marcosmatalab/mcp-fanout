...
| [`PROTOCOL.md`](PROTOCOL.md) | part 1 is the ten gate rules, and it is their single source; parts 2 and 3 are the three phases, the two phase B passes with their measured results, the sealed predictions, and when to stop | 6,200 words |
...
**11,930 words** of operation, plus 30 words of corpus material that is
