...
| 🧪 **713 passing tests** | Unit, integration and regression tests. Each instrument has a test that fails when the instrument is *absent*, not only when it is wrong |
...
tests/           713 passing tests plus a mock MCP server
```
